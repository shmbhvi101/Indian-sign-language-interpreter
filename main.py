...
label3 = Label(f1, text="HOME", font=("arial", 20, "bold"), bg="#130700", fg="white",
               relief=RAISED)
...
statusbar = Label(f1, text="Created by Shambhavi and Preesha", font=("arial", 11, "bold"),
  bg="#130700", fg="white", relief=RAISED, anchor=W)
...
def new_func(f1, AnimatedGIF):
    l = AnimatedGIF(f1, r"C:\Users\Shambhavi\Desktop\proj\IndianSignLanguageInterpreter\gif2.gif")

    return l

if __name__ == "__main__":
    l = new_func(f1, AnimatedGIF)
    l.pack()
